...
export default class EmbedApi extends EventTarget {
    constructor(options) {
        super();
        this.isReady = false;
        this.eventCallbacks = {};
    ...
    sendMessage(message, data) {
        ...
        if (this.iframe && this.iframe.contentWindow) {
            this.iframe.contentWindow.postMessage(JSON.stringify(messageObject), "https://instabook.io");
        }
        else {
...
//# sourceMappingURL=EmbedApi.js.map